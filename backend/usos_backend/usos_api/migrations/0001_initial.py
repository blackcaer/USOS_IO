    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('recipients', models.ManyToManyField(to='usos_api.studentgroup')),
            ],
        ),
        migrations.AddField(
            model_name='student',
            name='groups',
            field=models.ManyToManyField(blank=True, to='usos_api.studentgroup'),
        ),
        migrations.AddField(
            model_name='student',
            name='parents',
            field=models.ManyToManyField(blank=True, related_name='children', to='usos_api.parent'),
        ),
        migrations.CreateModel(
            name='ParentConsent',
            fields=[

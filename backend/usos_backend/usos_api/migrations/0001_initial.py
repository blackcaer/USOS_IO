    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('email', models.EmailField(default='email@example.com', max_length=254, unique=True)),
        ...
        migrations.AddField(
            ...
            name='students',
            field=models.ManyToManyField(related_name='student_groups', to='usos_api.student'),
        ),
        migrations.CreateModel(
            name='ParentConsent',
            fields=[
